CMD="PYTHONPATH=/home/localadmin/Priorization/python python3 /home/localadmin/Priorization/python/Scripts/paper/PlotCD8MutationsCnt.py -fp Figure_Mutation_imm_counts -fih 20 -fiw 30 -las 25 -tis 20 -les 20 -ps 100" 
#echo $CMD
#eval $CMD
